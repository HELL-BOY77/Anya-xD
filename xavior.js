...
let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/XzenzBotz'
                                }
                            }]
...
â•°â”€â”€â”€â”€
â•­â”€[ *MINAT CHAT* ]
â”œ  ðŸª€ wa.me/628988986891?text=SEWABOT
â•°â”€â”€â”€â”€
â•­â”€[ *PAYMENT* ]
â”œ  DANA
â”œ  GOPAY
...
â•°â”€â”€â”€â”€
â•­â”€[ *MINAT CHAT* ]
â”œ  ðŸª€ wa.me/628988986891?text=JADIBOT
â•°â”€â”€â”€â”€
â•­â”€[ *PAYMENT* ]
â”œ  DANA
â”œ  GOPAY
...
let btn = [{
            ...
            break
case 'gopay': {
                m.reply('GOPAY: 0895609803131')
            }
            break
case 'dana': {
                m.reply('DANA: 081213304135')
            }
            break
case 'pulsa': {
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hai ${pushname} Klik Dibawah Untuk Memunculkan Semua Fitur\n\nWoy ${pushname} Jangan Dispam Ye Botnya Ntr Delay\n`,
                    description: "*Pilih Salah Satu Opsional List Fitur Dibawah*",
                    buttonText: "MENU",
                    footerText: "©Anya-xD",
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "All Menu",
										"description": "Memunculkan Semua List Fitur Didalam Bot Ini",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Owner Menu",
										"description": "Mau Dibuatin Bot? Chat WAðŸ˜‰",
									...
									{
										"title": "Search Menu",
										"description": "Menampilkan Pencaharian Yang Ingin Dicari",
									...
									{
										"title": "Heker Menu",
										"description": "Jancuk Pistel, Pistel TemayoðŸ—¿",
...
let btn = [{
                                ...
                                urlButton: {
                                    displayText: 'Script🪶',
                                    url: 'https://github.com/XzennzBotz'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Rulesâ—',
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} Kak\n\nI Am ${global.namabot}, Bot Ini Masih Dalam Proses.\n\nKarna ${global.namabot} Adalah Hasil Uji Coba Dari Saya.\n\nKalau Abng Makai Botnya Tapi Ngelag, Itu Karna Abang WibuðŸ—¿`
                let btn = [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://youtube.com/channel/UCWOF5p3b7rRlEgN-f3S3V0w'
...
case 'menu': {
anu = `â•­â”€â *ã€Ž menu ã€*
â”‚ âžª Dana : 081213304135
â”‚ âžª Gopay : 08988986891
â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â

*TERIMA KASIH BUAT YANG SUDAH MAU menuðŸ¤—*`
let btn = [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://youtube.com/channel/UCWOF5p3b7rRlEgN-f3S3V0w'
