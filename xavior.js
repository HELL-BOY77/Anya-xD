...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'dm': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, ' 𝘼𝙣𝙮𝙖-𝙭𝘿 ', `Hello Admin Please Select Any Options In This Group ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
...
HELL-BOY-MD-V3 : https://github.com/HELL-BOY77/HELL-BOY-MD-V3
 ...
 𝘼𝙣𝙮𝙖-𝙭𝘿  : https://github.com/HELL-BOY77/Anya-xD`
let btn = [{
                                quickReplyButton: {
                                    displayText: '👀',
                                    id: '🌚'
