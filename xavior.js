...
Bot Script : https://github.com/HELL-BOY77/Anya-Xd-MD
...
let teks = `Tag All* 
 ...
 🔮 *Message : ${q ? q : 'Hello'}*\n\n`
	    ...
	    break
            ...
            if (!text) throw `Masukkan Reason Melakukan Vote, Example: *${prefix + command} Owner Ganteng*`
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'dm': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Disappearing message Options List !`, 'Anya-xD', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
